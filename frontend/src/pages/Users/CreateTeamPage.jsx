        ...
        <div className="grid min-h-screen z-50 py-10">
            <div className="flex flex-col justify-center items-center p-6 smp">
                <div className="w-full max-w-md space-y-8">
                    ...
                    <p className='text-center'>New team will be create and you will be assigned as the team leader</p>
                    {/* Form */}
                    ...
                    <div className="text-center">
                        <p className="text-base-content/50">
                            You Already have an team?, Join one!&nbsp;&nbsp;{""}
                            <Link to="/join-team" className="link link-primary">
                                join a team</Link>
                        </p>
                    </div>
                </div>
